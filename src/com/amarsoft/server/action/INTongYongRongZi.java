...
public class INTongYongRongZi extends Action {
	...
	protected Map<String, Object> action(Map<String, Object> requestMap,
		...
		try {
			...
			String sql = "select BC.CustomerName,BC.SerialNo,BC.CertID,BC.JimuID,BC.VouchCompany,BC.ProjectName,BC.ItemStatus,BC.BusinessSum,BC.TermMonth"
