 ...
 *
 */
public class DataMDXAcceptAction extends Action {
	@Override
	protected Map<String, Object> action(Map<String, Object> requestMap,
		...
		String sJMID = jMMMLoanHandle.jMMMloanSet((HashMap) CollectionUtil.getChangeMap(requestMap, new HashMap()), sqlQuery);
