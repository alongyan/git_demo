 ...
 *
 */
public class DataTJJAcceptAction extends Action {
	@Override
	protected Map<String, Object> action(Map<String, Object> requestMap,
		...
		String sJMID = jMTaoJinJiaHandle.jMTaoJinJiaSet((HashMap) CollectionUtil.getChangeMap(requestMap, new HashMap()), sqlQuery);
...
/*		if(!(checkMapKey(requestMap,"SPID") && checkMapKey(requestMap,"Ticket"))){
		...
		res.put("ProjectID", (String)requestMap.get("ProjectID"));
