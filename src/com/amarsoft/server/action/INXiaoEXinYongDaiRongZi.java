 ...
 *
 */
public class INXiaoEXinYongDaiRongZi extends Action {
	...
	protected Map<String, Object> action(Map<String, Object> requestMap,
		...
		try {
			...
			String sql = "select " +
					...
					"bc.BusinessType as BusinessType,"+//产品类型
			...
			while(rs.next()){
				...
				subData.put("type", getBusinessName(StrUtil.notNull(rs.getString("BusinessType"))));                        // 产品类型  
	...
	/**
	 * @describe 該方法對產品進行名稱映射
	 * @param notNull
	 * @return
	 */
	private String getBusinessName(String sBusinessType) {
		//1007000120	工薪贷	工薪贷
		//1007000180	企业贷	企业贷
		//1007010220	融薪贷	融薪贷
		//1007020220	融薪贷	融薪贷
		//1007040570	融薪贷	融薪贷
		if("1007010220".equals(sBusinessType) || "1007020220".equals(sBusinessType) || "1007040570".equals(sBusinessType)){
			return "融薪贷";
		}else if("1007000120".equals(sBusinessType)){
			return "工薪贷";
		}else if("1007000180".equals(sBusinessType)){
			return "企业贷";
		}else if("1007000220".equals(sBusinessType)){
			return "融薪贷-时代试用版";
		}
		return null;
	}
	...
	/**
	 * @describe 该方法用于获取产品信息内容
	 * @param sAgentOrg
	 * @return
	 */
	private String getBusinessType(String sAgentOrg) {
		////TJJ,JMSD,DIANXIAO,R360
		String sBusinessType = "";
		//淘金家
		if("JMSD".equals(sAgentOrg)){//若传递AgentOrg为JMSD则对积木时代自营业务 工薪贷、企业贷、、融薪贷
			sBusinessType = "'1007000120','1007000180'";
		} else if("DIANXIAO".equals(sAgentOrg)){//若传递Agent为 DIANXIAO 则对应积木时代业务为
			sBusinessType = "'1007040570'";
		} else if("R360".equals(sAgentOrg)){//若传递Agent为R360 则对应积木时代业务为
			sBusinessType = "'1007020220','1007020230'";
		}else if("TJJ".equals(sAgentOrg)){
			sBusinessType = "'1012000410'";
		}else if("JMSDQIJIAO".equals(sAgentOrg)){//若传递Angent为JMSDQIJIAO则对应为融薪贷-时代试用版
			sBusinessType = "'1007000220'";
		}
		return sBusinessType;
	}
	/**
	 * @describe 该方法用于获取截取共同借款人
	 * @param str
	 * @return
	 */
